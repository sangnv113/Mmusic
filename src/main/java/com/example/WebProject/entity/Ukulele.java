...
@Entity
@Table(name = "ukulele")
public class Ukulele implements Serializable{
	...
	public Ukulele(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong, String gia,
	...
	public Ukulele(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong) {
		super();
		this.id = id;
		this.name = name;
		this.categoryid = categoryid;
	...
	public Ukulele(int id, String name, Category categoryid, Producer producerid, Color colorid, double rate, int soluot,
