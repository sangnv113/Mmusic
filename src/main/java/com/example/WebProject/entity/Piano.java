...
public class Piano implements Serializable{
	...
	public Piano(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong, String gia,
	...
	public Piano(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong) {
		super();
		this.id = id;
		this.name = name;
		this.categoryid = categoryid;
	...
	public Piano(int id, String name, Category categoryid, Producer producerid, Color colorid, double rate, int soluot,
