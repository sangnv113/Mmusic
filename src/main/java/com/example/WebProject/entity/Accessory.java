...
public class Accessory implements Serializable{
	...
	public Accessory(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong, String gia,
	...
	public Accessory(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong) {
		super();
		this.id = id;
		this.name = name;
		this.categoryid = categoryid;
	...
	public Accessory(int id, String name, Category categoryid, Producer producerid, Color colorid, double rate, int soluot,
