...
public class Drum implements Serializable{
	...
	public Drum(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong, String gia,
	...
	public Drum(int id, String name, Category categoryid, Producer producerid, Color colorid, int soluong) {
		super();
		this.id = id;
		this.name = name;
		this.categoryid = categoryid;
	...
	public Drum(int id, String name, Category categoryid, Producer producerid, Color colorid, double rate, int soluot,
