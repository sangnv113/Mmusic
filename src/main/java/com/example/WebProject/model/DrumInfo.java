...
public class DrumInfo {
	...
	public DrumInfo(int id, String name, String category, int rate, String gia, int soluong, int giamgia, String giasaugiam) {
		super();
		this.id = id;
		this.name = name;
	...
	public DrumInfo(int id, String name, String datepr, String category, String producer, String color, int rate,
	...
	public DrumInfo(int id, String name,  String category, String producer, String color, int rate,
	...
	public DrumInfo(int id, String category, String producer, String color, int rate, int luotdanhgia,
