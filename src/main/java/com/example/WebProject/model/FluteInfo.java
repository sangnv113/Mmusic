...
public class FluteInfo {
	
	public FluteInfo(int id, String name, String category, int rate, String gia, int soluong, int giamgia, String giasaugiam) {
		super();
		this.id = id;
		this.name = name;
	...
	public FluteInfo(int id, String name, String datepr, String category, String producer, String color, int rate,
	...
	public FluteInfo(int id, String name,  String category, String producer, String color, int rate,
	...
	public FluteInfo(int id, String category, String producer, String color, int rate, int luotdanhgia,
